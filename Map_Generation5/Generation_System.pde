...
void generate()
{
  ...
  for (int a=0; a<closed.size(); a++)
  {
    ...
    grids.get((gy2*75)+gx2).blocked=false;
    ...
    grids.get((gy2*75)+gx2-1).state=2;
    grids.get((gy2*75)+gx2+1).state=2;
    grids.get((gy2*75)+gx2-75).state=2;
    grids.get((gy2*75)+gx2+75).state=2;
    grids.get((gy2*75)+gx2).state=2;
    grids.get((gy1*75)+gx1-1).state=2;
    grids.get((gy1*75)+gx1+1).state=2;
    grids.get((gy1*75)+gx1-75).state=2;
    grids.get((gy1*75)+gx1+75).state=2;
    grids.get((gy1*75)+gx1).state=2;
    int red, green, blue;
  ...
  println(", teleporter placement");
  delay(500);
  //Check if there are any dead ends that are not marked as bonus room or boss, if there are create a teleporter
  for (int a=0; a<rooms.size(); a++)
  {
    if (rooms.get(a).connections.size()>1)
      continue;
    if (rooms.get(a).bonus==false && rooms.get(a).boss==false)
      rooms.get(a).teleporter=true;
  }
